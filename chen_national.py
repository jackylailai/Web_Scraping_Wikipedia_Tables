...
r = requests.get("https://zh.wikipedia.org/wiki/%E8%87%BA%E5%8C%97%E5%B8%82%E5%9C%8B%E5%AE%9A%E5%8F%A4%E8%B9%9F%E5%88%97%E8%A1%A8")
soup = BeautifulSoup(r.text, "html.parser")#臺北市國定古蹟列表
...
df.to_excel("nation.xlsx", sheet_name="nation", index=False)  # 匯出Excel檔案(不寫入資料索引值)
